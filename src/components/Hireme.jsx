...
const Hireme = () => {
  ...
  return (
    <section id="hireme" className="py-16 px-4 text-white bg-gray-900 relative overflow-hidden">
      ...
      <div className="relative px-6 py-10 mt-20 mx-auto bg-gradient-to-br from-gray-700 to-gray-800 rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.6)] max-w-6xl flex flex-col-reverse lg:flex-row items-center gap-6 transform transition-all duration-700 hover:scale-[1.01] hover:shadow-[0_20px_60px_rgba(0,0,0,0.7)]">
        {/* Text Section */}
        <div className="z-10 lg:w-1/2">
          ...
          <form ref={formRef} onSubmit={handleSayHello} className="mt-8">
          ...
          {/* Status Message */}
          {status && (
            <p className="mt-4 text-sm text-green-400 animate-fade-in">{status}</p>
          )}
        </div>
