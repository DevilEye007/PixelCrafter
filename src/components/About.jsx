  ...
  return (
    <section id="about" className="py-14 text-white bg-[#0f172a]">
      ...
      <div className="flex md:flex-row flex-col-reverse items-center md:gap-10 gap-12 px-6 md:px-20 max-w-7xl mx-auto mt-10">
        {/* About Text Block */}
        <div className="p-4 bg-[#1f2937] rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.3)] transform hover:scale-[1.02] hover:rotate-[1deg] transition-all duration-700 ease-in-out">
          ...
          {/* Info Stats with 3D Animation */}
          <div className="flex mt-10 items-center gap-10 justify-center md:justify-start">
            {info.map((content) => (
              <div
                key={content.text}
